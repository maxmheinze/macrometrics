...
\end{aligned}
$$
Our posterior is proportional to a Beta distribution. Thus the Beta prior was indeed a conjugate prior.
...
## Exercise 2.4
*Discuss the assumption of independent and identically distributed data:*
