...
With regard to making a decision regarding which hyperparameters to use, it makes sense to consider the literature background as well as the empirical data at hand and make an informed decision on how much shrinkage to impose. In general, a guiding value could be that $\lambda_1 > \lambda_1\cdot\lambda_2$, because own lags are more likely to be important predictors than lags of other variables.
